...
<nav class="navbar">
  <div class="container">
    <div class="logo"> <a href="index.html"> <img src="images/logo.png" srcset="images/logo@2x.png" alt="Image"> </a> </div>
    <!-- end logo -->
    <div class="site-menu">
      <ul>
        <li><a href="#">What We Offer</a>
<ul>
        ...
        <li><a href="food-farming.html">Food & Farming</a>
		  <ul>
				<li><a href="explore-farming.html">Explore Farming</a></li>
				<li><a href="our-work.html">Our Work</a></li>
				<li><a href="farming-issues.html">Farming Issues</a></li>
      ...
      <div class="col-lg-8">
		  ...
		  <figure><img src="images/blog01.jpg" alt="Image"></figure>
			  ...
			  <h3 class="post-title">What About Farming, Food and You</h3>
				  <p>The Consumer Hub provides a forum for consumers to share 
ideas, questions, and concerns about agriculture.
</p> <a href="news-single.html" class="custom-link">Read All Conversation</a>
			  </div>
			  <!-- end post-content -->
		  </div>
		  <!-- end blog-post -->
...
ideas, questions, and concerns about agriculture.
		  ...
		  <!-- end blog-post -->
		  <div class="blog-post">
		  <figure><img src="images/blog04.jpg" alt="Image"></figure>
			  <div class="post-content">
				  <span class="post-date">Dec 26, 2020</span>
			  <h3 class="post-title">What About Farming, Food and You</h3>
				  <p>The Consumer Hub provides a forum for consumers to share 
ideas, questions, and concerns about agriculture.
		  ...
		  <!-- end blog-post -->
		  <div class="blog-post">
		  <figure><img src="images/blog05.jpg" alt="Image"></figure>
			  <div class="post-content">
				  <span class="post-date">Dec 26, 2020</span>
			  <h3 class="post-title">What About Farming, Food and You</h3>
				  <p>The Consumer Hub provides a forum for consumers to share 
